...
totalcode = instCpStockCode.GetCount()
print('total stocks :', totalcode)

for i in range(totalcode):
    names = instCpStockCode.getData(1, i)
    codes = instCpStockCode.getData(0, i)
    """
    instStockChart.SetInputValue(0, codes)
...
for i in range(numData):
    ...
    for j in range(numField):
        ...
        print(instStockChart.GetDataValue(3, i), end=' ')
